	...
	<header id="masthead" class="site-header header-two" role="banner" itemscope itemtype="http://schema.org/WPHeader">
        ...
        <div class="header-top">
            <div class="container">
                ...
                <div id="secondary-mobile-header">
    			    <a id="responsive-secondary-menu-button" href="#sidr-main2"><?php esc_html_e( 'Menu', 'charity-care' ); ?></a>
    			</div>
        ...
        <div class="header-bottom">
            ...
            <div class="container">
                ...
                <?php 
                    $button_text = get_theme_mod( 'benevolent_button_text', __( 'Donate Now', 'charity-care' ) );
                ...
                <div id="mobile-header">
    			    <a id="responsive-menu-button" href="#sidr-main"><?php esc_html_e( 'Menu', 'charity-care' ); ?></a>
    			</div>
