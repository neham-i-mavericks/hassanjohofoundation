...
if( !function_exists('gdlr_register_required_plugins') ){
	function gdlr_register_required_plugins(){
		$plugins = array(
			...
			array(
				'name'     				=> 'Goodlayers Cause',
				'slug'     				=> 'gdlr-cause', 
				'version'               => '1.0.0',
				'source'   				=> GDLR_LOCAL_PATH . '/include/plugin/plugins/gdlr-cause.zip',
				'required' 				=> true,
				'force_activation' 		=> false,
				'force_deactivation' 	=> true, 
			),
			...
			array('name' => 'MailPoet Newsletters', 'slug' => 'wysija-newsletters', 'required' => true),
