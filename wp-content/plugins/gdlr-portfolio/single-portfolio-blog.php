				...
				<div class="with-sidebar-content <?php echo $gdlr_sidebar['center']; ?> columns">
					...
					<?php while ( have_posts() ){ the_post(); ?>
						...
						<nav class="gdlr-single-nav">
							<?php previous_post_link('<div class="previous-nav">%link</div>', '<i class="icon-angle-left fa fa-angle-left"></i><span>%title</span>', true); ?>
							<?php next_post_link('<div class="next-nav">%link</div>', '<span>%title</span><i class="icon-angle-right fa fa-angle-right"></i>', true); ?>
							<div class="clear"></div>
						</nav><!-- .nav-single -->
